        ...
        ?>
         ...
         <form method="post"  action="../../action/user/updateUserAction.php"name="formName">
             <table border="1px">
                 ...
                 <tr><td colspan="2"><input type="submit" value="修改信息"onclick="isNull()"></td></tr>
             </table>
        ...
        <script type="text/javascript">
            function isNull(){
                ...
                if(pass.length>0){
                    ...
                    alert("信息修改失败,密码不可为空！");
                    formName.action='userDetails.php';
                }
            }
        </script>
    </body>
