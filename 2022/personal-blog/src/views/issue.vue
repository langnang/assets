<template>
  <div>
    <div class="wrapper">
      <!-- Begin Intro -->
      <div class="intro">
        Nulla vitae elit libero, a pharetra augue. Vivamus sagittis lacus augue
        laoreet rutrum faucibus dolor auctor. Cras mattis consectetur purus sit
        amet fermentum, Vestibulum id ligula porta.
      </div>
      <ul class="social">
      ...
      <div class="content box">
        ...
        <p>
          ...
          dapibus posuere velit aliquet. Fusce dapibus, tellus ac cursus
        ...
        <div class="outer none">
          <span class="inset"
            ><img src="@/assets/art/se1.jpg" alt="" title=""
          /></span>
        </div>

        <p>
          Donec ullamcorper nulla non metus auctor fringilla. Maecenas sed diam
          eget risus varius blandit sit amet non magna. Donec id elit non mi
          porta gravida at eget metus. Fusce dapibus, tellus. Vivamus sagittis
          lacus vel augue laoreet rutrum faucibus dolor auctor. Donec id elit
          non mi porta gravida at eget metus. Cum sociis natoque penatibus et
        ...
        <p>
          ...
          massa justo sit amet risus. Integer posuere erat a ante venenatis
      ...
      <div class="sidebar box">
        <div class="sidebox widget">
          ...
          <ul class="post-list">
            <li>
              <div class="frame">
                <a href="#"
                  ><span class="more"></span><img src="@/assets/art/s1.jpg"
                /></a>
              </div>
              <div class="meta">
        ...
        <div class="sidebox widget">
          ...
          <div>
            Suspendisse eu odio quis elit ultrice commodo tempor eget arcu.
            Sedur aliquet posuere lectus aliquam iaculi. Curabitur a risus
            metus. In ut lorem nisl, et adipiscing sapien. Donec sed risus
            tristiq scelerisque.
          </div>
        </div>
