...
<head>
  ...
  <title>简历模板</title>
  {{-- <link rel="stylesheet" href="css/base.css" media="screen and (min-width: 840px)" /> --}}
  {{-- <link rel="stylesheet" href="css/style.css" media="screen and (max-width: 839px)" /> --}}
  ...
  <div id="wrapper">
    <div class="header">
      <div class="header-title">
        <span class="author-name">XXX</span>
      ...
      <div class="header-list">
        <div class="header-left">
          <ul>
            <li>联系方式： XXX</li>
            <li>邮箱： <a href="mailto:xxxxxxx@163.com">xxxxxxx@qq.com</a></li>
            <li>学历： 本科/硕士/博士</li>
          </ul>
        </div>
    ...
    <div class="person-info">
      ...
      <div class="detail-list">
        <div class="info-left">
          <span>籍贯： XXXXX</span>
          <span>学校： XX学校/XX专业/2012</span>
          <span>工作年限： 4年</span>
        </div>
        <div class="info-right">
          <span>出生年月： 1993.08.28/天秤座</span>
          <span>GitHub： <a href="#">www.xxxxxx.com</a></span>
          <span>个人网站： <a href="#">www.xxxxxx.com</a></span>
        </div>
        <div class="clear-fix"></div>
      </div>
    </div>
    ...
    <div class="pro-skill">
      ...
      <div class="detail-list">
        <ul>
          <li>Web开发： Javascript(精通)/xxx/xxxx/xxxxxx/xxxxx</li>
          <li>前端： HTML(5)/xxxxx/xxxxxx/xxxxxx/xxxxx/xxxxxxx</li>
          <li>数据库： MySQL/xxxx</li>
          <li>服务器相关： 熟悉Linux基本命令/xxxxx</li>
        </ul>
      </div>
    </div>
      ...
      <div class="detail-list">
        <ul>
          <li>
            ...
            <span>一款使用Spring Framework +
              AngularJS写的单页应用博客系统，使用MyBatis作为ORM框架，写作语法支持Markdown。部署在阿里云的CentOS服务器上，使用Nginx作的权限控制和端口转发。</span>
            <span class="source-url">源代码地址：<a href="#">www.xxxxxx.com</a></span>
          </li>
          <li>
            <span class="source-name">项目名称：xxxx</span><br>
            <span>里边存放了从开始学写代码后的一些记录，ACM刷题、Java学习、Android学习、框架以及其他的学习，并有使用JS、Java、Android写过的一些小东西。</span>
