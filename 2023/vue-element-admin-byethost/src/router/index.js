...
export const constantRoutes = [
  ...
  //       name: 'Category',
  //       meta: { title: '分类管理', icon: 'guide', noCache: true, type: 'category' }
  //     }
  //   ]
  // },
  // {
  ...
  //       component: () => import('@/views/base/index'),
  //       name: 'Tag',
  //       meta: { title: '标签管理', icon: 'guide', noCache: true, type: 'tag' }
  //     }
  //   ]
  // },
  // {
  ...
  //       component: () => import('@/views/base/index'),
  //       name: 'Content',
  //       meta: { title: '内容管理', icon: 'guide', noCache: true, type: 'post' }
  //     }
  //   ]
  // },
  // {
  ...
  //     {
  //       path: '/',
  //       component: () => import('@/views/webstack/index'),
  //       name: 'WebStack',
  //       meta: { title: 'WebStack', icon: 'documentation', }
  //     }
  //   ]
  // },
  // require('./modules/webstack')['default'],
  // require('./modules/icon')['default'],
  // require('./modules/article')['default'],
  // require('./modules/snippet')['default'],
  // require('./modules/book')['default'],
  // require('./modules/awesome')['default'],
  // require('./modules/cheatsheet')['default'],
  // require('./modules/software')['default'],
  // require('./modules/openapi')['default'],
  // require('./modules/comment')['default'],
  // require('./modules/spider')['default'],
  // require('./modules/video')['default'],
  // require('./modules/audio')['default'],
  // require('./modules/novel')['default'],
  // require('./modules/user')['default'],
  require('./modules/option')['default'],
  {
    path: '/about',
    component: Layout,
    children: [
      {
        ...
        name: 'About',
        meta: { title: '关于我们', icon: 'user', noCache: true }
      }
    ]
  },
  {
