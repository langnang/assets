<template>
  <div id="app">
    <h1>单曲播放模式</h1>
    <h3>单曲播放</h3>
    <LnAudioPlayer :src="audioList[0]" @play="onPlay" @pause="onPause" @playing="onPlaying" @ended="onEnded" @progress-change="onProgressChange" @volume-change="onVolumeChange" />
    <h3>单曲循环</h3>
    <LnAudioPlayer :src="audioList[2]" :show-mode="true" :loop="true" @play="onPlay" @pause="onPause" @playing="onPlaying" @ended="onEnded" @progress-change="onProgressChange" @volume-change="onVolumeChange" @mode-change="onModeChange" />
    <h1>多曲播放模式</h1>
    <LnAudioPlayer :src-list="audioList" :show-mode="true" play-mode="random" @play="onPlay" @pause="onPause" @playing="onPlaying" @ended="onEnded" @progress-change="onProgressChange" @volume-change="onVolumeChange" @mode-change="onModeChange" @play-prev="onPlayPrev" @play-next="onPlayNext" />
  </div>
</template>
