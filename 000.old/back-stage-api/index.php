...
require_once $_SERVER['DOCUMENT_ROOT'].'/backStageAPI/Models/FeedbackModel.php';

require_once $_SERVER['DOCUMENT_ROOT']."/backStageAPI/Controllers/".$router["controller"]."Controller.php";
