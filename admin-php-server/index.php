...
// IP 白名单
$ipWhiteList = ["127.0.0.1", "106.13.199.4"];
// API
$apiWhiteList = ["/api/user/login", "/api/crawler/list", "/api/crawler/info", "/api/crawler/update"];
// 一般用于本地脚本，无法验证token
$ipApiWhiteList = ["/api/crawler/list", "/api/crawler/info", "/api/crawler/update", "/api/phpspider/list", "/api/phpspider/info", "/api/phpspider/update"];
...
$dispatcher = FastRoute\simpleDispatcher(function (FastRoute\RouteCollector $router) {
  $router->addGroup("/api", function (FastRoute\RouteCollector $router) {
    require_once 'src/apis/index.php';
  });
...
if (is_string($handler) && $handler == "render_view") {
} else {
