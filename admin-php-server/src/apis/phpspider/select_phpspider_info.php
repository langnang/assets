<?php
$GLOBALS["ROUTER_PARAMS"]["select_phpspider_info"] = array(
  "post" => array(
    "id" => array(
      "desc" => "网站编号",
      "type" => "int",
 ...
 * 
 */
$router->addRoute("POST", "/phpspider/info", "select_phpspider_info");
function select_phpspider_info($data)
{
  $_data = $data["post"];
  ...
  return [
    ...
    "rows" => (new phpspiderController())->select($item),
  ];
}
